...
// Importaciones de imágenes (Ajustar según la ubicación real)
...
/* ============================================================
  COMPONENTE REUTILIZABLE PARA TARJETAS (CORREGIDO)
  ============================================================ */
function StyleCards({ background, className, children, width, height }) {
  return (
    <Card
      className={className}
      style={{
        backgroundColor: background,
        width: width,   // ACEPTA LA PROP width
        height: height, // ACEPTA LA PROP height
      }}
    >
      {children}
    </Card>
    ...
    <main className="home-container">
      ...
      <div className="content-wrapper">
        <section className="home-grid">
          {user.tipoCuenta === 0 ? (
            /* =========================== CATEGORÍAS – USUARIO NORMAL (CORREGIDO) =========================== */
            <StyleCards
              className="home-card full-card"
              width="100%" {/* CORREGIDO: Ancho completo para usuario normal */}
              background="#fff"
            >
        ...
        {/* =========================== MIS TURNOS AGENDADOS / RESERVADOS (CORREGIDO) =========================== */}
        <section className="bottom-section">
          <StyleCards
            className="home-card full-card"
            width="100%" {/* RESTAURADO: Necesita width="100%" inline */}
            background="#fff"
          >
